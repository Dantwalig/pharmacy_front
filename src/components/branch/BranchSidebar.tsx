...
import { Squares2X2Icon, UsersIcon, ClockIcon, LockClosedIcon, ArrowRightOnRectangleIcon, XMarkIcon, ChartBarIcon, CubeIcon, ArrowsRightLeftIcon, MapIcon } from '@heroicons/react/24/outline';
