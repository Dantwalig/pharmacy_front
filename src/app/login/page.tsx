        ...
        <div>
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-blue-100 leading-relaxed">
              Sign in to access your account and continue managing your healthcare journey with Evuze.
            </p>
          </div>

          {/* Features */}
          <div className="space-y-6">
            <p className="text-xl font-semibold mb-4">With Evuze, you can:</p>
            
            <div className="flex items-start gap-4">
              <MapPinIcon className="w-8 h-8 shrink-0 mt-1" />
              <div>
            ...
            <div className="flex items-start gap-4">
              <ClockIcon className="w-8 h-8 shrink-0 mt-1" />
              <div>
            ...
            <div className="flex items-start gap-4">
              <UserGroupIcon className="w-8 h-8 shrink-0 mt-1" />
              <div>
            ...
            <div className="flex items-start gap-4">
              <ShieldCheckIcon className="w-8 h-8 shrink-0 mt-1" />
              <div>
