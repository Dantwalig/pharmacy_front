// frontend/src/app/staff/change-password/page.tsx
...
export default function StaffChangePasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // PUT /staff/profile/change-password
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-violet-600 to-violet-900 flex items-center justify-center p-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div key={key}>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-9 py-2.5 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg text-sm focus:ring-2 focus:ring-violet-500 outline-none"
                  />
                  <button type="button" onClick={() => toggle(field)} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-linear-to-r from-violet-600 to-violet-800 hover:from-violet-700 hover:to-violet-900 text-white py-3 rounded-xl font-semibold transition-all disabled:opacity-50 flex items-center justify-center gap-2 mt-2"
            >
              {loading ? (
