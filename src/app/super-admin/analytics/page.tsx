...
export default function SuperAdminAnalyticsPage() {
  ...
  const metrics = [
    ...
    },
    {
      ...
      sub: `${formatCurrency(analytics?.platformFeePerPharmacy)}/pharmacy/month`,
    },
  ];
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">
                {formatCurrency(revenue?.transactionCount ? ((revenue.totalRevenue ?? 0) / revenue.transactionCount) : 0)}
              </p>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-bold text-gray-900 dark:text-gray-100">
                {formatCurrency(analytics?.platformFeePerPharmacy)}
              </span>
            </div>
          </div>
        </div>
