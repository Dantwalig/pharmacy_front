...
import {
  ...
  ArrowsRightLeftIcon, MapIcon, LockClosedIcon, XMarkIcon, ArrowRightOnRectangleIcon, CalendarDaysIcon
...
export default function BranchSidebar({ open = false, onClose }: BranchSidebarProps) {
  ...
  const nav = [
    ...
    { href: '/branch/leave',           icon: CalendarDaysIcon,    label: t('branch.leave') },
